      ...
      <View style={styles.overlay}>
        <View style={styles.sheet}>
          ...
          <View style={styles.tabsContainer}>
            <TouchableOpacity style={[styles.tabButton, activeTab === "single" && styles.activeTab]} onPress={() => setActiveTab("single")} >
              <Text
                style={[
                  styles.tabText,
            ...
            renderItem={({ item }) => {
              ...
              return (
                <TouchableOpacity style={styles.userRow} onPress={() => toggle(item?.chatId?.toString())}>
                  <Avatar uri={(item?.friend?.profileImage || "https://imgs.search.brave.com/xCedoimthG97d8n6Aqc-6LyqR2Oa5N-3B_5XNwx_Hqc/rs:fit:500:0:1:0/g:ce/aHR0cHM6Ly91cGxv/YWQud2lraW1lZGlh/Lm9yZy93aWtpcGVk/aWEvY29tbW9ucy9h/L2FjL0RlZmF1bHRf/cGZwLmpwZz9fPTIw/MjAwNDE4MDkyMTA2") || item?.group?.images?.[0] } size={44} isOnline={item?.isOnline} />
